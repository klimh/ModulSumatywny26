        ...
        <div className="w-full flex-1 flex flex-col min-h-0 overflow-hidden relative bg-background">
            ...
            {showAbortModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
                    <div className="bg-panel border border-outline rounded-3xl p-8 max-w-md w-full shadow-2xl flex flex-col gap-6 animate-scale-up">
                        <div className="flex flex-col gap-2">
                            ...
                            <h2 className="text-xl font-bold">{t('dashboard.session.abort')}</h2>
                            <p className="text-sm text-muted">
                                {t('dashboard.session.abortConfirm')}
                            </p>
                        </div>
                        <div className="flex gap-3 justify-end mt-2">
                            <button
                                onClick={() => setShowAbortModal(false)}
                                className="px-5 py-2.5 rounded-xl text-sm font-semibold text-muted hover:text-white hover:bg-white/5 transition-colors"
                            >
                            ...
                            <button
                                ...
                                className="px-5 py-2.5 rounded-xl text-sm font-semibold bg-rose-500 text-white hover:bg-rose-600 transition-colors shadow-lg shadow-rose-500/20"
                            >
                                {t('dashboard.session.abort')}
                            </button>
                        </div>
